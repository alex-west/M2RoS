; This file was automatically generated from samus.csv. Please edit that file instead of this one.
    ...
    dw poseFunc_running ; $03 - Running
    ...
    dw poseFunc_bombed ; $11 - Standing bombed
    dw poseFunc_morphBombed ; $12 - Morphball bombed
    dw poseFunc_faceScreen ; $13 - Facing screen
    dw poseFunc_faceScreen ; $14 - Unused
    dw poseFunc_faceScreen ; $15 - Unused
    dw poseFunc_faceScreen ; $16 - Unused
    dw poseFunc_faceScreen ; $17 - Unused
