; This file was automatically generated from samus.csv. Please edit that file instead of this one.
    ...
    dw drawSamus_faceScreen ; $14 - Unused
    dw drawSamus_faceScreen ; $15 - Unused
    dw drawSamus_faceScreen ; $16 - Unused
    dw drawSamus_faceScreen ; $17 - Unused
